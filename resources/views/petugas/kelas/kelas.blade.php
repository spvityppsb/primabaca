    ...
    <div class="container-fluid px-xxl-65 px-xl-20 mt-20">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon">
                    <i class="material-icons">class</i></span>Data Tipe Keanggotaan
            </h4>
        </div>
        ...
        <div class="row justify-content-md-center">
            <div class="col-xl-6">
                <section class="hk-sec-wrapper">
                    <p class="mb-40">
                        <button class="btn btn-primary btn-wth-icon btn-sm" data-toggle="modal" data-target="#createkelas">
                            <span class="icon-label">
                                <span class="material-icons">
                                    control_point
                                </span>
                            </span>
                            <span class="btn-text">Tambah Tipe Keanggotaan Baru</span>
                        </button>
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Form Tambah Tipe Keanggotaan</h5>
                                ...
                                <form action="{{ route('kelas.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <label for="validationCustom01">Nama Tipe Keanggotaan</label>
                                            <input type="text" class="form-control" name="jenis_kelas"
                                                id="validationCustom01" placeholder="SDYPPSB2-3B/PEGAWAI-KPC" required>
                                        </div>
                                    </div>
                                            ...
                                            @foreach ($kelas as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form id="kelas-delete-form-{{ $data->id_kelas }}"
                                                            action="{{ route('kelas.destroy', $data->id_kelas) }}"
                                                            method="POST" class="d-none">
                                                            @csrf
                                                            @method('delete')
                                                        </form>
                                                    </td>
                                                    <div class="modal fade" id="updatekelas{{ $data->id_kelas }}"
                                                        tabindex="-1" role="dialog"
                                                        aria-labelledby="updatekelas{{ $data->id_kelas }}"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <form action="{{ route('kelas.update', $data->id_kelas) }}"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            <label for="validationCustom01">Nama
                                                                                Tipe Keanggotaan</label>
                                                                            <input type="text" class="form-control"
                                                                                name="jenis_kelas" id="validationCustom01"
                                                                                placeholder="SDYPPSB2-3B/PEGAWAI-KPC"
                                                                                value="{{ $data->jenis_kelas }}" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
