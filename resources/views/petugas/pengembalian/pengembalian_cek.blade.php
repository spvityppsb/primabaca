                            ...
                            <div class="card text-white">
                                ...
                                <div class="card-body bg-white" style="color:black">
                                    ...
                                    <form action="{{ route('peminjaman.store') }}" method="post"
                                        ...
                                        <button class="btn btn-primary w-100 mt-10" type="submit" name="submit">Proses
                                                ...
                                                <tbody>
                                                    ...
                                                    @forelse ($pinjam as $data)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @php
                                                                    ...
                                                                    if ($n <= $t) {
                                                                        ...
                                                                        $denda = $hari;
                                                                        echo '<span class="badge badge-danger"> Terlambat ' .
                                                                            $hari .
                                                                            ' Hari </span>';
                                                                    }
                                                                @endphp
                                                            ...
                                                            <td>
                                                                <form action="{{ route('pengembalian.proses') }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('post')
                                                                    ...
                                                                    <input type="text" name="nominal"
                                                                        value="{{ $nominal }}" hidden>
                                                                    <input type="text" name="id"
                                                                        value="{{ $data->id_pinjam }}" hidden>
                                                                    <button type="submit" href=""
                                                                        class="btn btn-primary btn-sm btn-rounded"
                                                                        onclick="return confirm('Apakah Buku dan Denda Telah Sesuai Dengan Sistem ?')">Proses
                                                                        Buku</button>
                                                                </form>
                                                            </td>
                                                        </tr>
                                                    @empty
                                                        <tr>
                                                            <td colspan="8" class="text-center">Siswa Tidak Memiliki
                                                                Peminjaman Buku</td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
