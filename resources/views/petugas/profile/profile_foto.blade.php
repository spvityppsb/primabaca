                ...
                <div class="bg-white shadow-bottom">
                    <div class="container-fluid px-xxl-65 px-xl-20">
                        <ul class="nav nav-light nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a href="{{ route('profile.index') }}" class="d-flex h-60p align-items-center nav-link">Data
                                    Akun</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card card-profile-feed">
                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('profile.foto_update', Auth::user()->id) }}"
                                                ...
                                                <button type="submit" class="btn btn-primary mt-30 w-100">Perbaharui Foto
                                                    Profile</button>
                                            </form>
                                        </div>
                                    </div>
