...
@section('content')
    <div class="container-fluid px-xxl-65 px-xl-20 mt-20">
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="fa fa-book"></i></span>Update Layanan Perpustakaan
            </h4>
        </div>
            ...
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <form action="{{ route('layanan.update', $layanan->id_layanan) }}" method="post"
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-10">
                                ...
                                <input type="text" name="judul"
                                    class="form-control @error('judul') is-invalid @enderror" value="{{ $layanan->judul }}"
                                    placeholder="Judul">
                                @error('judul')
                            ...
                            <div class="col-md-4 mb-10">
                                ...
                                <input type="text" name="slug"
                                    class="form-control @error('slug') is-invalid @enderror" value="{{ $layanan->slug }}"
                            ...
                            <div class="col-md-4 mb-10">
                                ...
                                <input type="text" name="keterangan"
                                    ...
                                    value="{{ $layanan->keterangan }}" placeholder="Keterangan">
                                @error('keterangan')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-10">
                                ...
                                <input type="text" name="url" class="form-control @error('url') is-invalid @enderror"
                                    value="{{ $layanan->url }}" placeholder="Keterangan">
                                @error('url')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm">
                                <label for="foto">Foto Layanan Perpustakaan</label>
                                <input type="hidden" name="oldImage" value="{{ $layanan->foto }}">
                                @if ($layanan->foto == null)
                                    <input type="file" id="input-file-now" name="foto" class="dropify" />
                                @else
                                    <input type="file" id="input-foto-now" name="foto" class="dropify"
                                        data-default-file="/storage/{{ $layanan->foto }}" />
                                    @error('foto')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                @endif
                        ...
                        <button class="btn btn-primary btn-wth-icon mt-10 w-100" type="submit">
                            <span class="btn-text">Update Layanan Perpustakaan</span>
                        </button>
                    </form>
                </section>
            </div>
