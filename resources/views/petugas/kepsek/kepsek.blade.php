    ...
    <div class="container-fluid px-xxl-65 px-xl-20 mt-20">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon">
                    <i class="material-icons">school</i></span>Data Supervisor
            </h4>
        </div>
                    ...
                    @if ($cek_kepsek->count() < 1)
                        <p class="mb-40">
                            <button class="btn btn-primary btn-wth-icon btn-sm" data-toggle="modal"
                                ...
                                <span class="btn-text">Tambah Data Supervisor</span>
                            </button>
                        </p>
                    @endif
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Form Tambah Supervisor</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-2">
                                            <div class="form-group">
                                                <label for="validationCustom01">Nomor Induk Supervisor</label>
                                        ...
                                        <div class="mb-2">
                                            <div class="form-group">
                                                <label for="validationCustom01">Nama Lengkap Supervisor</label>
                                                <input type="text" class="form-control" name="nama_kepsek"
                                                    id="validationCustom01" placeholder="Nama Supervisor" required>
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                            <div class="form-group">
                                                <label for="validationCustom01">Jenis Kelamin Supervisor</label>
                                        ...
                                        <div class="mb-2">
                                            <div class="form-group">
                                                <label for="validationCustom01">Tanggal Lahir Supervisor</label>
                                        ...
                                        <div class="mb-2">
                                            <div class="form-group">
                                                <label for="validationCustom01">Foto Supervisor</label>
                                                <input type="file" id="input-file-now" name="foto_kepsek" class="dropify"
                                                    required />
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-wrap">
                                <div class="table-responsive">
                                    <table class="table table-sm mb-0">
                                        <thead>
                                            <tr>
                                                <th>Nomor Induk Pegawai Supervisor</th>
                                                <th>Nama Lengkap</th>
                                                <th>Jenis Kelamin</th>
                                                <th>Tanggal Lahir</th>
                                                <th>Foto</th>
                                        ...
                                        <tbody>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="mb-2">
                                                                            <div class="form-group">
                                                                                <label for="validationCustom01">Nomor Induk
                                                                                    Supervisor</label>
                                                                        ...
                                                                        <div class="mb-2">
                                                                            <div class="form-group">
                                                                                <label for="validationCustom01">Jenis
                                                                                    Kelamin Supervisor</label>
                                                                                <select class="form-control custom-select"
                                                                                    name="jenis_kelamin_kepsek">
                                                                                    <option value="l"
                                                                                        {{ $data->jenis_kelamin_kepsek == 'l' ? 'selected' : '' }}>
                                                                                        Laki - Laki</option>
                                                                                    <option value="p"
                                                                                        {{ $data->jenis_kelamin_kepsek == 'p' ? 'selected' : '' }}>
                                                                                        Perempuan</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="mb-2">
                                                                            <div class="form-group">
                                                                                <label for="validationCustom01">Tanggal
                                                                                    Lahir Supervisor</label>
                                                                                <input type="date" class="form-control"
                                                                                    value="{{ $data->tgl_lahir_kepsek }}"
                                                                                    name="tgl_lahir_kepsek"
                                                                                    id="validationCustom01" required>
                                                                            </div>
                                                                        </div>
                                                                        <div class="mb-2">
                                                                            <div class="form-group">
                                                                                <label for="validationCustom01">Foto Kepala
                                                                                    Sekolah</label>
                                                                                <input type="file" id="input-file-now"
                                                                                    name="foto_kepsek" class="dropify"
                                                                                    data-default-file="/foto_kepsek/{{ $data->foto_kepsek }}" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="3" class="text-center">Data Supervisor Tidak Ada
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
