                                            ...
                                            @foreach ($rak as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('rak.destroy', $data->id_rak) }}"
                                                        ...
                                                        <form id="rak-delete-form-{{ $data->id_rak }}"
                                                            action="{{ route('rak.destroy', $data->id_rak) }}"
                                                            method="POST" class="d-none">
                                                            @csrf
                                                            @method('delete')
                                                        </form>
                                                    </td>
                                                    <div class="modal fade" id="updaterak{{ $data->id_rak }}" tabindex="-1"
                                                        role="dialog" aria-labelledby="updaterak{{ $data->id_rak }}"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <form action="{{ route('rak.update', $data->id_rak) }}"
