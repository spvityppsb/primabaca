...
@section('content')
    <div class="container-fluid px-xxl-65 px-xl-20 mt-20">
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="material-icons">groups</i></span>Edit Petugas
                Perpustakaan</h4>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <p class="mb-40">Formulir Pengisian Data Petugas Pendaftaraan Sebagai Petugas Perpustakaan Primabaca
                        YPPSB</p>
                    <form action="{{ route('petugas.update', $petugas->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-10">
                                ...
                                <input type="number" name="nip" class="form-control @error('nip') is-invalid @enderror"
                                    id="validationCustom01" placeholder="Nomor Induk Pegawai" value="{{ $petugas->nip }}"
                                    autofocus>
                                @error('nip')
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-10">
                                ...
                                <input type="text" name="nama_petugas"
                                    class="form-control @error('nama_petugas') is-invalid @enderror" id="validationCustom01"
                                    placeholder="Nama Lengkap Siswa" value="{{ $petugas->name }}">
                                @error('nama_petugas')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-10">
                                ...
                                <input type="number" name="telp"
                                    ...
                                    placeholder="No Telp" value="{{ $petugas->telp }}">
                                @error('telp')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm">
                                ...
                                @else
                                    <input type="file" id="input-file-now" name="foto" class="dropify"
                                        data-default-file="/foto_petugas/{{ $petugas->foto }}" />
                                @endif
                            </div>
                        </div>
