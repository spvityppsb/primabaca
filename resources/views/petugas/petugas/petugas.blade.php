        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    ...
                    <p class="mb-20">Data Petugas Yang Penanggung Jawab Pada Sistem Perpustakaan Primabaca YPPSB</p>
                    <a href="{{ route('petugas.create') }}" class="btn btn-primary btn-wth-icon btn-sm mb-20">
