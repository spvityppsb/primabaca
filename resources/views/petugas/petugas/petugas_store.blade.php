...
@section('content')
    <div class="container-fluid px-xxl-65 px-xl-20 mt-20">
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><i class="material-icons">groups</i></span>Petugas Perpustakaan
            </h4>
        </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <p class="mb-40">Formulir Pengisian Data Petugas Pendaftaraan Sebagai Perpustakaan Primabaca YPPSB</p>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-10">
                                ...
                                <input type="number" name="nip" class="form-control @error('nip') is-invalid @enderror"
                                    id="validationCustom01" placeholder="Nomor Induk Pegawai" value="{{ old('nip') }}"
                                    autofocus>
                                @error('nip')
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-10">
                                ...
                                <input type="text" name="nama_petugas"
                                    ...
                                    placeholder="Nama Lengkap Siswa" value="{{ old('nama_petugas') }}">
                                @error('nama_petugas')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
