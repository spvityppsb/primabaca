                    ...
                    <form action="{{ route('buku.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-10">
                                ...
                                <input type="text" name="judul_buku"
                                    class="form-control @error('judul_buku') is-invalid @enderror" id="validationCustom01"
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-10">
                                <label for="validationCustom01">Penerbit</label>
                            ...
                            <div class="col-md-2 mb-10">
                                ...
                                <select name="tahun_terbit" id="tahun_terbit"
                                    ...
                                    value="{{ old('tahun_terbit') }}" placeholder="Tahun"></select>
                                @error('tahun_terbit')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-10">
                                <label for="validationCustom01">No. ISBN</label>
                            ...
                            <div class="col-md-2 mb-10">
                                ...
                                <input type="number" name="stok"
                                    ...
                                    value="{{ old('stok') }}" placeholder="Stok Buku">
                                @error('stok')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
