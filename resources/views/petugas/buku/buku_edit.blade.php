        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <p class="mb-40">Formulir Pengisian Data Buku Perpustakaan Primabaca YPPSB</p>
                    <form action="{{ route('buku.update', $buku->id_buku) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-10">
                                ...
                                <input type="text" name="kode_buku"
                                    class="form-control @error('kode_buku') is-invalid @enderror" id="validationCustom01"
                                    placeholder="Kode Buku" value="{{ $buku->kode_buku }}" autofocus disabled>
                                @error('kode_buku')
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-10">
                                ...
                                <input type="text" name="judul_buku"
                                    class="form-control @error('judul_buku') is-invalid @enderror" placeholder="Judul Buku"
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-10">
                                ...
                                <input type="text" name="penulis"
                                    class="form-control @error('penulis') is-invalid @enderror" value="{{ $buku->penulis }}"
                                    placeholder="Penulis">
                                @error('penulis')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-2 mb-10">
                                <label for="validationCustom01">Tahun Terbit</label>
                                <input type="text" name="tahun_terbit" id="tahun_terbit"
                                    class="form-control @error('tahun_terbit') is-invalid @enderror"
                                    value="{{ $buku->tahun_terbit }}" placeholder="Tahun"></input>
                                @error('tahun_terbit')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-10">
                                ...
                                <input type="text" name="isbn"
                                    class="form-control @error('isbn') is-invalid @enderror" value="{{ $buku->isbn }}"
                                    placeholder="No. ISBN">
                                @error('isbn')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-6 mb-10">
                                ...
                                <select class="form-control custom-select @error('rak') is-invalid @enderror"
                                    name="rak">
                                    <option value="">Pilih Rak Buku</option>
                                    @foreach ($rak as $data)
                                        <option value="{{ $data->id_rak }}"
                                            {{ $data->id_rak == $buku->rak ? 'selected' : '' }}>
                                            {{ Str::title($data->jenis_rak) }}</option>
                                    @endforeach
                                </select>
                                @error('rak')
                                    <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="col-md-2 mb-10">
                                ...
                                <input type="number" name="stok"
                                    class="form-control @error('stok') is-invalid @enderror" value="{{ $buku->stok_buku }}"
                        ...
                        <div class="form-row">
                            <div class="col-sm">
                                ...
                                <input type="file" id="input-file-now" name="foto" class="dropify"
                                    data-default-file="/foto_buku/{{ $buku->foto_buku }}" />
                                @error('foto')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <button class="btn btn-primary btn-wth-icon mt-10 w-100" type="submit">
                            <span class="btn-text">Perbaharui Buku</span>
                        </button>
                    </form>
                </section>
            </div>
