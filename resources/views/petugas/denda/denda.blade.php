                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm mb-0">
                                        ...
                                        <tbody>
                                            @forelse ($denda as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('denda.destroy', $data->id_denda) }}"
                                                        ...
                                                        <form id="denda-delete-form-{{ $data->id_denda }}"
                                                            action="{{ route('denda.destroy', $data->id_denda) }}"
                                                            method="POST" class="d-none">
                                                            @csrf
                                                            @method('delete')
                                                        </form>
                                                    </td>
                                                    <div class="modal fade" id="updatedenda{{ $data->id_denda }}"
                                                        tabindex="-1" role="dialog"
                                                        aria-labelledby="updatedenda{{ $data->id_denda }}"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                ...
                                                                <form action="{{ route('denda.update', $data->id_denda) }}"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number" class="form-control"
                                                                                name="nominal_denda"
                                                                                id="validationCustom01" placeholder="5000"
                                                                                value="{{ $data->nominal_denda }}"
                                                                                required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="2" class="text-center">Nominal Denda Belum Di Atur
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
